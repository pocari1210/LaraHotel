              ...
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <img id="showImage" src="{{ (!empty($book->photo)) ? url('storage/upload/bookarea/'.$book->photo) : url('storage/upload/no_image.jpg') }}" alt="BookArea" class="rounded-circle p-1 bg-primary" width="80">
                  </div>
                </div>
