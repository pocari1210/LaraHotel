                    ...
                    <div class="card-body p-4">
                      ...
                      <form class="row g-3" action="{{ route('update.room',$editData->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                          ...
                          <img id="showImage" src="{{ (!empty($editData->image)) ? url('storage/upload/roomimg/'.$editData->image) : url('storage/upload/no_image.jpg') }}" alt="Admin" class="bg-primary" width="70" height="50">
                        </div>
                            ...
                            <div class="basic_facility_section_remove" id="basic_facility_section_remove">
                              <div class="row add_item">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group" style="padding-top: 30px;">
                                    <a class="btn btn-success addeventmore"><i class="lni lni-circle-plus"></i></a>
                                    <span class="btn btn-danger btn-sm removeeventmore"><i class="lni lni-minus-circle"></i></span>
                                  </div>
                                </div>
                              </div>
                            </div>
