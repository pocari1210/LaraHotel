                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 col-md-6">
                          <div class="form-group">
                            ...
                            <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('storage/upload/user_images/'.$profileData->photo) : url('storage/upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                          </div>
                        </div>
